...
namespace Giometric.UniSonic.Objects
{
    public class ObjectTriggerBase : MonoBehaviour
    {
        ...
        public UnityEvent<ObjectTriggerBase, PlayerMovement> PlayerEnteredTrigger;
        public UnityEvent<ObjectTriggerBase, PlayerMovement> PlayerLeftTrigger;
        ...
        protected virtual void OnPlayerEnterTrigger(PlayerMovement player) { }
        protected virtual void OnPlayerExitTrigger(PlayerMovement player) { }
    }
}